...
public enum PlayerProperty {
    ...
    PROP_CUR_SPRING_VOLUME					(10003, true), // Current HP "stored" in a statue. [0, PROP_MAX_SPRING_VOLUME]
    PROP_IS_SPRING_AUTO_USE					(10004, 0, 1), // Automatic nearby HP recovery. (boolean) [0, 1]
    PROP_SPRING_AUTO_USE_PERCENT			(10005, 0, 100), // Maximum amount of HP to recover. (percentage) [0, 100]
    ...
    PROP_PLAYER_MP_SETTING_TYPE				(10017, 0, 2), // Player co-op join setting. [0 = never, 1 = always, 2 = by approval]
    PROP_IS_MP_MODE_AVAILABLE				(10018, 0, 1), // Player co-op enabled. [0, 1]
    PROP_PLAYER_WORLD_LEVEL					(10019, 0, 8), // Player world level. [0, 8]
    PROP_PLAYER_RESIN						(10020, 0, 2000), // Player stored original resin. [0, 160, 2000] - note that values above 160 require refills
    PROP_PLAYER_WAIT_SUB_HCOIN				(10022),
    PROP_PLAYER_WAIT_SUB_SCOIN				(10023),
    PROP_IS_ONLY_MP_WITH_PS_PLAYER			(10024, 0, 1), // Force co-op only with PlayStation users? (boolean) [0, 1]
