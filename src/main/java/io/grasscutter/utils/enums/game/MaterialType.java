...
@AllArgsConstructor
@Getter public enum MaterialType {
    MATERIAL_NONE                    (0),
    MATERIAL_FOOD                    (1),
    MATERIAL_QUEST                   (2),
    MATERIAL_EXCHANGE                (4),
    ...
    static {
        // Cache the values.
        Stream.of(MaterialType.values()).forEach(entry -> {
    ...
    /**
     * Fetches the MaterialType by its value.
     *
     * @param value The value of the MaterialType.
     * @return The MaterialType.
     */
    public static MaterialType fetch(int value) {
        return map.getOrDefault(value, MATERIAL_NONE);
    }

    /**
     * Fetches the MaterialType by its name.
     *
     * @param name The name of the MaterialType.
     * @return The MaterialType.
     */
