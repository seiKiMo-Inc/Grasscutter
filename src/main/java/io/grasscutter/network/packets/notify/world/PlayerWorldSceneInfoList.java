...
@AllArgsConstructor
public final class PlayerWorldSceneInfoList
        extends BasePacket<Empty, PlayerWorldSceneInfoListNotify> {
    @Override
    public PlayerWorldSceneInfoListNotify preparePacket() {
        return PlayerWorldSceneInfoListNotify.newBuilder()
                .addInfoList(PlayerWorldSceneInfo.newBuilder().setSceneId(1).setIsLocked(false))
                .addInfoList(
                ...
                .addInfoList(
                        PlayerWorldSceneInfo.newBuilder()
                                ...
                                .addSceneTagIdList(117)
                                .setIsLocked(false))
                .addInfoList(PlayerWorldSceneInfo.newBuilder().setSceneId(5).setIsLocked(false))
                .addInfoList(PlayerWorldSceneInfo.newBuilder().setSceneId(6).setIsLocked(false))
                .addInfoList(PlayerWorldSceneInfo.newBuilder().setSceneId(7).setIsLocked(false))
                .addInfoList(
                        PlayerWorldSceneInfo.newBuilder()
                                .setSceneId(9)
